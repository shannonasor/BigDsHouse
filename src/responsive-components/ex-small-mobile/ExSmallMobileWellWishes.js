...
const ExSmallMobileWellWishes = () => {
  ...
  return (
    <div className="Well-wishes-ex-small-mobile create"  >
      <h1>Advice For Shakeya</h1>

      <form className='advice-for-graduate' onSubmit={handleSubmit} style={{ backgroundImage: "url(/wellwishesphoto.jpg)", backgroundPosition: 'left 35% bottom',
